<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Atheltes_UpdateAthelet.aspx.cs" Inherits="aspmuser.Athlete.Atheltes_UpdateAthelet" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="UpdateAthletStyles.css" />
    <title></title>
        <style type="text/css">
        .auto-style3 {
            margin-left: 280px;
           ...
           <div class="form-box" runat="server">
            <h1>
             ...
             <div class="input-group" runat="server">
                  ...
                  <input id="txtTrainer" type="text" runat="server" class="input-field" placeholder="Trainer"/>
