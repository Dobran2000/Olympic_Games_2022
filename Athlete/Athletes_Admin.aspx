<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Athletes_Admin.aspx.cs" Inherits="aspmuser.Athelts.Athelts_Admin" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<link rel="stylesheet" href="Athelte_Admin.css"/>
...
<%--  <a class="active" href="#home">Home</a>--%>
  ...
  <a href="#5"></a>
  <a href="#6"></a>
  <a href="Athletes_List.aspx">Show</a>
  <a href="Athletes_AddNewAthlete.aspx">Create</a>
  <a href="Athletes_FindAthelete.aspx"><i class="fa fa-fw fa-search"></i>Find</a>
  <a href="Atheltes_UpdateAthelet.aspx">Update</a>
  <a href="Athletes_DeleteAthlete.aspx">Delete</a>
