<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Event_User_FindEvent.aspx.cs" Inherits="aspmuser.Events_User.Event_FindUser" %>
...
<head runat="server">
    <link rel="stylesheet" href="EventUserFind.css" />
    <title></title>
</head>
<body>
<form runat="server">
...
<asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" AllowPaging="true"
    ...
    <Columns>
        <asp:BoundField DataField="event_name" HeaderText="Game" ItemStyle-Width="100" />
