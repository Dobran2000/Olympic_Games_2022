...
{
    public partial class Games_User_List : System.Web.UI.Page
    {
        ...
        private DataTable GetData()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("select Year(game_year) as 'Anul',game_name 'Joc' ,season as 'Sezon', event_name as 'Eveniment' , game_description as 'Description' from Games g " +
