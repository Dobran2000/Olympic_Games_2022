<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Games_User_FindGame.aspx.cs" Inherits="aspmuser.Games_User.Games_User_FindGame" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="stylesheet" href="GamesUserFind.css" />
    <title></title>
</head>
<body>
<form runat="server">
...
<asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" AllowPaging="true"
    OnPageIndexChanging="OnPaging" Height="251px" Width="500px" class="GridPosition"  >
    <Columns>
        ...
        <asp:BoundField DataField="game_year" HeaderText="Year" ItemStyle-Width="100" />
    </Columns>
</asp:GridView>
    </form>
</body>
