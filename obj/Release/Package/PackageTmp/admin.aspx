<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="aspmuser.AdminPage.admin" %>
...
<%--  <a class="active" href="#home">Home</a>--%>
  <a class="active" href="Games_Admin.aspx"><i class="fa fa-fw fa-home"></i> Home</a>
  <a href="About.aspx">About</a>
   <a href="Contact.aspx"><i class="fa fa-fw fa-envelope"></i> Contact</a>
  <a href="#4"></a>
  <a href="#5"></a>
  <a href="#6"></a>
  <a href="Games/Games_Admin.aspx">Games</a>
  <a href="Athlete/Athletes_Admin.aspx">Athletes</a>
  <a href="Events/Event_Admin.aspx">Events</a>
  <a href="Results/Results_Admin.aspx">Results</a>
  <a href="Trainers/Trainers.aspx">Trainers</a>
  <a href="Medals/MedalList.aspx">Medals</a>
</div>
      ...
      <div class="ct-blog col-sm-6 col-md-4">
        <div class="inner">
          ...
          <div class="ct-blog-content">
            ...
            <h3 class="ct-blog-header">
              After Rio , Angelina Melnikova thought "I'm not going 
